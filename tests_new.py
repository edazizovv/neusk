...
def check_up(y, y_hat, model, x_numerical):
    ...
    r2_adj = 1 - (1 - r2_orig) * (x_numerical.shape[0] - 1) / (x_numerical.shape[0] - x_numerical.shape[1])
    ...
    results = {
        ...
        'Self-Model regression on Y R-squared statistic': numpy.nan,
